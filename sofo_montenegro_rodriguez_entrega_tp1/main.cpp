...
::::::::::::::ccccccccccc:::::::cccc:cccccccccccccccccccccc:ccccccccc:::cc:::ccc                      
      ...
      cout << "4) salir" << endl;
      cin >> opcion;
      if (cin.fail() || (opcion != 1 && opcion != 2 && opcion != 3 && opcion != 4))
     {
      cin.clear();                
      cin.ignore(numeric_limits<streamsize>::max(),'\n');
      cout << "Error. Por favor, ingrese una opción valida: ";
      cin >> opcion;
     }
    ...
    switch (opcion)
    {
     ...
     cin >> iniciarJuego;
     while (cin.fail() || (iniciarJuego != 's' && iniciarJuego != 'n'))
     {
      cin.clear();                
      cin.ignore(1000, '\n');     
      cout << "Error. Por favor, ingrese una opción valida: ";
...
;;,,;;,,,,,,,,....''''',,,,,,,,,,,''''''''...'''...............................
       ...
       if(miniJuego == true)
       {
         ...
         for (int i = 1; i <= 3; i++)
         {
           ...
           cin >> eleccionJugador;
           if (cin.fail() || (eleccionJugador != 1 && eleccionJugador != 2 && eleccionJugador != 3))
           {
            cin.clear();                
            cin.ignore(numeric_limits<streamsize>::max(),'\n');   
            cout << "Error. Por favor, ingrese una opción valida: ";
